...
SoftwareSerial CMPS12 = SoftwareSerial(rxPin,txPin);
...
void loop()
{
  Serial.print(CMPS12.write(CMPS_GET_ANGLE16));  // Request and read 16 bit angle
  delay(1000);
  while(CMPS12.available() < 2){
    Serial.print("Waiting for response - nb of bytes available: ");
    Serial.println(CMPS12.available());
